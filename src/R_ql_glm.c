...
void c_compute_adjust_s2 (double *, double *, int *, int *, double *, int *, double *, double *, double *, double *, double *, double *,double *, double *);
void c_compute_adjust_s2_non (double *, double *, int *, int *, double *, int *, double *, double *, double *, double *, double *);

SEXP compute_adjust_s2 (SEXP y, SEXP mu, SEXP de, SEXP di, SEXP wo)
{
    SEXP ans;
    ...
    c_compute_adjust_s2(REAL(y), REAL(mu), &nt, &nl, REAL(de), &nv, REAL(di), REAL(wo), REAL(df), REAL(dev), REAL(s2), REAL(lever), REAL(unitdev), REAL(unitdf));       
...
SEXP compute_adjust_s2_non (SEXP y, SEXP mu, SEXP de, SEXP di, SEXP wo)
{
    SEXP ans;
    SEXP df, dev, s2, lever, unitdev, unitdf;
    int nt, nl, nv;
    ...
    /* call compute function */
    c_compute_adjust_s2_non(REAL(y), REAL(mu), &nt, &nl, REAL(de), &nv, REAL(di), REAL(wo), REAL(df), REAL(dev), REAL(s2));       
